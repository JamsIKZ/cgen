...
export function ReasoningBasic() {
  const reasoningText = `Based on the current market trends and on-chain data, CGEN's decentralized AI media protocol shows strong potential for growth. The platform's unique tokenomics and permissionless access to AI-generated content creation positions it well in the emerging web3 media landscape.`;
